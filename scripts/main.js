...
function displayCardsDynamically(collection) {
    ...
    db.collection(collection)
        .orderBy("last_updated", "desc") //sorts by this detail //desc is used to reverse the list
        .limit(3) // number we want returned
...
// displayCardsDynamically("hikes");  //input param is the name of the collection // called from doAll now
...
// Better function for updating and removing bookmark
